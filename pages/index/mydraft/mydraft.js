// pages/index/mydraft/mydraft.js
Page({
  ...
  data: {
    device: [
      { iconurl: '/images/my_sao.png', title: '系统信息', tap: 'showSystemInfo' },
      { iconurl: '/images/my_sao.png', title: '网络状态', tap: 'showNetWork' },
      { iconurl: '/images/my_sao.png', title: '地图显示', tap: 'showMap' },
      { iconurl: '/images/my_sao.png', title: '指南针', tap: 'showCompass' },
      { iconurl: '/images/my_sao.png', title: '当前位置、速度', tap: 'showLonLat' },
      { iconurl: '/images/my_sao.png', title: '摇一摇', tap: 'shake' },
      { iconurl: '/images/my_sao.png', title: '扫一扫', tap: 'scanQRCode' }
    ],
  compassVal: 0,
  compassHidden: true,
  shakeInfo: {
